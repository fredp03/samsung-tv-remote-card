...
console.info(
  `%c SAMSUNG-TV-REMOTE-CARD %c v1.0.0 `,
...
class SamsungTvRemoteCard extends LitElement {
  ...
  render() {
    ...
    return html`
      <div class="remote" style="zoom: ${scale};">
        <!-- Power Button -->
        <div class="control-buttons-top">
          <button
            class="icon-button small"
            @click=${() => this._sendKey("power")}
            title="Power"
          >
            <svg
              width="24"
        ...
        <div class="control-buttons-middle">
          ...
          <button
            ...
            @click=${() => this._sendKey("play_pause")}
            title="Play/Pause"
          >
            <svg
              width="24"
